...
public class Driver {
	...
	public static void main(String[] args) {
		...
		// The new keyword requests a block memory of DataTypes' size to store the object in, and 
		//   returns the memory address. This address is stored in dt.
		// The final word, DataTypes(), says to run the constructor immediately on creation.
		
		int a = 1, b = 2;
		System.out.println(dt.add(a, b));
